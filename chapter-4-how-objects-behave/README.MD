...
- A class is te blueprint for an object.
...
- You can send more than on thing to a method:
...
public void setHeight(int ht) { 
    if (ht > 9 ) { // we put in checks to guarantee a minium cat height
        height = ht;
    }
}
```
